...
namespace ProvaPub.Controllers
{
	...
	public class Parte2Controller :  ControllerBase
	{
        ...
        [HttpGet("products")]
		public async Task<PagedList<Product>> ListProducts(int page = 1, int pageSize = 10)
		{
			return await _productService.GetPagedList(page, pageSize);
		}

		[HttpGet("customers")]
		public async Task<PagedList<Customer>> ListCustomers(int page = 1, int pageSize = 10)
		{
			return await _customerService.GetPagedList(page, pageSize);
		}
	}
}
